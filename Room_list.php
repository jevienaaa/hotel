...
<div class="container">
    ...
    <div style="text-align: center; margin-top: 20px;">
        <input type="button" value="ADD ROOM" class="dropbtn" onclick="window.location.href='http://localhost/hotel/Room_update_form.php'">
        <input type="button" value="VIEW ROOM" class="dropbtn" onclick="window.location.href='http://localhost/hotel/Room_list_display.php'">
    </div>
        ...
        <table class="table table-hover">
            ...
            <tbody style="color:black">
                ...
                <tr>
                    ...
                    <td><a href="Room_edit_form.php?id=<?php echo $row["room_id"]; ?>" class="btn btn-primary">EDIT</a></td>
                    <td><a href="Room_Delete.php?id=<?php echo $row["room_id"]; ?>" class="btn btn-danger">DELETE</a></td>
                </tr>
                <?php
                    }
                } else {
