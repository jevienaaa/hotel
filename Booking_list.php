...
<div class="container">
    ...
    <!-- Buttons for Adding and Viewing Admins -->
    <div style="text-align: center; margin-top: 20px;">
        <input type="button" value="ADD BOOKING" class='dropbtn' onclick="window.location.href='http://localhost/hotel/Booking_update.php'">
        <input type="button" value="VIEW BOOOKING" class='dropbtn' onclick="window.location.href='http://localhost/hotel/Booking_list_display.php'">
    </div>
        ...
        <table class="table table-hover">
            ...
            <tbody style="color:black">
                ...
                <tr>
                    ...
                    <td>
                        <input type="button" value="EDIT" class='dropbtn edit-btn' onclick="window.location.href='http://localhost/hotel/Booking_edit.php?id=<?php echo $row["booking_id"]; ?>'">
                    </td>
                    <td>
                        <input type="button" value="DELETE" class='dropbtn delete-btn' onclick="window.location.href='http://localhost/hotel/Booking_delete.php?id=<?php echo $row["booking_id"]; ?>'">
                    </td>
                </tr>
                <?php
                    }
