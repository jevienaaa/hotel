...
<div class="container">
    ...
    <div style="text-align: center; margin-top: 20px;">
        <input type="button" value="ADD ADMIN" class='dropbtn' onclick="window.location.href='http://localhost/hotel/Admin_update.php'">
        <input type="button" value="VIEW ADMIN" class='dropbtn' onclick="window.location.href='http://localhost/hotel/Admin_list_display.php'">
    </div>
    <!-- Admin List Table -->
        ...
        <table class="table table-hover">
            ...
            <tbody style="color:black">
                ...
                <tr>
                    ...
                    <td>
                        <input type="button" value="EDIT" class='dropbtn edit-btn' onclick="window.location.href='http://localhost/hotel/Admin_edit_form.php?id=<?php echo $row["owner_id"]; ?>'">
                    </td>
                    <td>
                        <input type="button" value="DELETE" class='dropbtn delete-btn' onclick="window.location.href='http://localhost/hotel/Admin_delete.php?id=<?php echo $row["owner_id"]; ?>'">
                    </td>
                </tr>
                <?php
                    }
