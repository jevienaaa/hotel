...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $user['cus_password'])) {
            ...
            header('Location: guestnav.php');
            exit();
        } else {
            $error_message = 'Invalid username or password, try <a href="customer_login.php">Login</a> again.';
        }
    } else {
        $error_message = 'Invalid username or password, try <a href="customer_login.php">Login</a> again.';
    }
...
<head>
    ...
    <title>Ashton Hotel - Guest Login</title>
...
<body>
    ...
    <div class="content">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="text_box">
                <label for="cus_name">Username:</label>
            ...
            if (!empty($error_message)) {
                ...
                echo '<p class="psw">Not Registered? <a href="http://localhost/hotel/Customer_registration.php">Register here.</a></p>';
            }
            ?>
        </form>
    </div>
